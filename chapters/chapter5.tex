...
In order to measure the distance between two Gaussian distributions, assume the mean of one Gaussian distribution is the observation for the other distribution, therefore, 
