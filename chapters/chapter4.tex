...
\begin{figure}[h!]
  \centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=0.8\textwidth]{measure_camera_color.png}};
...
\begin{figure}[h!]
  \centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0,0) {\includegraphics[width=\textwidth]{measure_err_clean_color.png}};
    \begin{scope}[x={(image.south east)},y={(image.north west)}]
